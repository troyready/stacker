...
class Action(BaseAction):
    ...
    def build_parameters(self, stack, provider_stack=None):
        ...
        final_list = []
        for p in [{'ParameterKey': p[0], 'ParameterValue': str(p[1])} for p in parameters]:
            if p['ParameterValue'] == '****' and stack.blueprint.parameters[p['ParameterKey']].properties['NoEcho']:
